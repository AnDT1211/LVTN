...
roadirc = RoadIRC(INIT_RoadIRC_SUG(init_params));
roadgbt = RoadGBT(INIT_RoadGBT_SUG(init_params));
...
saveas(figure(1), 'img/Compare/IRC_SUGvsGBT_SUG/r_road.png');
...
leg1 = strcat('IRC suggestion non-linear');
leg2 = strcat('IRC suggestion linear');
leg3 = strcat('GB/T suggestion non-linear');
leg4 = strcat('GB/T suggestion linear');
...
xlabel('Time (s)');
ylabel('Displacement (m)');
saveas(figure(1), 'img/Compare/IRC_SUGvsGBT_SUG/a1_dis.png');
...
saveas(figure(2), 'img/Compare/IRC_SUGvsGBT_SUG/a2_revdis.png');
...
saveas(figure(3), 'img/Compare/IRC_SUGvsGBT_SUG/a3_acc.png');
...
ylabel('BVA (m/s^2)');
saveas(figure(1), 'img/Compare/IRC_SUGvsGBT_SUG/v1_BVA.png');
...
saveas(figure(2), 'img/Compare/IRC_SUGvsGBT_SUG/v2_RMSA.png');
...
xlabel('Car speed (km/h)');
ylabel('SDD (m)');
saveas(figure(3), 'img/Compare/IRC_SUGvsGBT_SUG/v3_SDD.png');
...
xlabel('Car speed (km/h)');
ylabel('TDL (N)');
saveas(figure(4), 'img/Compare/IRC_SUGvsGBT_SUG/v4_TDL.png');
