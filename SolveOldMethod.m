classdef SolveOldMethod < handle
    %SOLVEOLDMETHOD Summary of this class goes here
    ...
    methods
        function obj = SolveOldMethod(init, airspring)
            obj.init = init;
        ...
        function SolvingTimeResponse(obj, init_x)
%             obj.road.v = v;
            [obj.T, obj.X_lin]  = ode45(@obj.PTVP_lin, obj.t, [0; 0; init_x; 0]); 
            [obj.T, obj.X_non]  = ode45(@obj.PTVP_non, obj.t, [0; 0; init_x; 0]); 
            
            obj.a_non = -(polyval(obj.congthucStiff, obj.X_non(:,3)-obj.X_non(:,1))...
                /obj.init.ms).*(obj.X_non(:,3)-obj.X_non(:,1)) ... 
